			...
			<div class="row">
				...
				<div class="col-lg-8">
					...
					<form class="singup-form contact-form" method="post">
						...
						<div class="col-md-6 mb-4 mt-3 custom-margin-155rem">
							<a href="login.php" class="txthref">Already have account? Click here</a>
						</div>
						<div class="col-md-4 custom-margin-16rem">
